...
load_features = function() {
  ...
  HRTR_features = unique(c(HRTR_f,HRTRJ48_f, HRTR_))
  ...
  HERHRJ48_f <- c(V2185)
  HERHRJ48_features = c(HERHHR_f, HERHRJ48_f)
  
  
  ### HER+HR~TRIPLE-
  # Best accuaracy with all the feature than with the feature selection. 0.88
  Subset_J48 <- c(V2185,V2026,V1657,V736,V1688,V306,V736,V59,V487,V2762)
