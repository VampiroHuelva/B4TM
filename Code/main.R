...
# the number of features is optimus for each algorithm, and then select the best algortihm
...
models = data.frame("nnet" = 1:10, "rf"=1:10, "gbm" = 1:10, "glm" = 1:10)
models
